...
/* 1 - D1 Yellow */
#define LED1_BV           BV(0)            //ivan
#define LED1_SBIT         P1_0             //ivan
#define LED1_DDR          P1DIR            //ivan
#define LED1_POLARITY     ACTIVE_LOW       //ivan
...
/* Mic power */
#define MIC_VDD_BV        BV(7)         //ivan
#define MIC_VDD_SBIT      P1_7          //ivan
#define MIC_VDD_DDR       P1DIR         //ivan

/* Motor */
#define MOTOR_PORT        P1             //ivan
#define MOTOR_BIT         BV(1)          //ivan
#define MOTOR_SBIT        P1_1           //ivan
#define MOTOR_DIR         P1DIR          //ivan
#define MOTOR_SEL         P1SEL          //ivan

/* Switch */
#define SWITCH_BV         BV(0)          //ivan
#define SWITCH_SBIT       P0_0           //ivan
#define SWITCH_DDR        P0DIR          //ivan

/* DCDC control */
#define DCDC_BV           BV(0)         //ivan
#define DCDC_SBIT         P2_0          //ivan
#define DCDC_DDR          P2DIR         //ivan
#define DCDC_SEL          P2SEL         //ivan

/* Accelerometer interrupt 1 */
#define ACC_INT1_BV        BV(1)         //ivan
#define ACC_INT1_SBIT      P0_1          //ivan
#define ACC_INT1_DDR       P0DIR         //ivan
#define ACC_INT1_SEL       P0SEL         //ivan

/* Accelerometer interrupt 2 */
#define ACC_INT2_BV        BV(2)         //ivan
#define ACC_INT2_SBIT      P0_2          //ivan
#define ACC_INT2_DDR       P0DIR         //ivan
#define ACC_INT2_SEL       P0SEL         //ivan
...
{                                                                \
  ...
  LED1_DDR |= LED1_BV;                                           \
  MIC_VDD_DDR |= MIC_VDD_BV;                                     \
  DCDC_DDR |= DCDC_BV;     /* Set P0_7 as output */              \
  MIC_VDD_SBIT = 1;  /* DC2DC must be on to power the board  */  \
}
